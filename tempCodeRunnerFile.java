...
class DrawingBoardPanel extends JPanel {
        ...
        addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent e) {
                ...
                if (currentShapeType == ShapeType.TEXT) {
                    ...
                    if (textToAdd != null) {
                        ...
                        g.setColor(isEraserMode ? new Color(18, 18, 18) : Color.WHITE);
            ...
            public void mouseReleased(MouseEvent e) {
                if (currentShapeType == ShapeType.FREEHAND) {
                    ...
                    ShapeStroke stroke = new ShapeStroke(new Rectangle2D.Float(x, y, width, height), isEraserMode ? new Color(18, 18, 18) : Color.WHITE, strokeWidth);
                    ...
                    int width = Math.abs(startPoint.x - endPoint.x);
                    int height = Math.abs(startPoint.y - endPoint.y);
                    ShapeStroke stroke = new ShapeStroke(new Ellipse2D.Float(x, y, width, height), isEraserMode ? new Color(18, 18, 18) : Color.WHITE, strokeWidth);
                    addShapeStroke(stroke);
                }
                startPoint = null;
                prevPoint = null;
    ...
    public void drawFreehand() {
        ...
        ShapeStroke stroke = new ShapeStroke(curve, isEraserMode ? new Color(18, 18, 18) : Color.WHITE, strokeWidth);
        addShapeStroke(stroke);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (textToAdd != null && isAddingText) {
            ...
            g2d.setColor(isEraserMode ? new Color(18, 18, 18) : Color.WHITE);
...
class ControlPanel extends JPanel {
    ...
    public JToggleButton modeToggleButton; // Light mode and dark mode toggle button
    ...
    public ControlPanel(DrawingBoardPanel drawingBoard) {
        ...
        modeToggleButton = new JToggleButton("Light Mode");
        modeToggleButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (modeToggleButton.isSelected()) {
                    ...
                    drawingBoard.setBackground(new Color(18, 18, 18));
                    drawingBoard.setForeground(Color.WHITE);
                    ...
                    drawingBoard.setForeground(Color.BLACK);
                    eraserButton.setForeground(Color.BLACK);
                    strokeSlider.setForeground(Color.BLACK);
        ...
        // Add tooltips
        ToolTipManager.sharedInstance().setInitialDelay(0); // Show tooltips immediately
        eraserButton.setToolTipText("Switch between eraser and pencil");
        strokeSlider.setToolTipText("Adjust stroke width");
        shapeSelector.setToolTipText("Select shape to draw");
